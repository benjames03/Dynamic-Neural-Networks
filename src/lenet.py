...
class SimLeNet(nn.Module):
    ...
    def inject_faults(self, faults, set=1, method="out"):
        self.conv1.inject_faults(faults, set, method)
        self.conv2.inject_faults(faults, set, method)
        self.linear1.conv.inject_faults(faults, set, method)
        self.linear2.conv.inject_faults(faults, set, method)
        self.linear3.conv.inject_faults(faults, set, method)
