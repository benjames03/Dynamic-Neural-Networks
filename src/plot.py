...
ax1.plot(data[1]["thresholds"], data[1]["accuracies"], label="ResNet18 Accuracy", color=COLOURS[2], marker="o", ms=3)
ax2.plot(data[1]["thresholds"], data[1]["losses"], label="ResNet18 Loss", color=COLOURS[3], marker="o", ms=3)
ax1.legend(loc="center right", bbox_to_anchor=(1, 0.65))
...
ax3.plot(data[1]["thresholds"], data[1]["cpu_time"], label="ResNet18 Time", color=COLOURS[2], marker="o", ms=3)
ax4.plot(data[1]["thresholds"], data[1]["operations"], label="ResNet18 Operations", color=COLOURS[3], marker="o", ms=3)
